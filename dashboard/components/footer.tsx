        ...
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    ...
                    <Image src="/logo-colored.png" width={200} height={200} className="w-20 h-20" alt="logo"/>
                </Link>
                ...
                {/* Legal Links */}
                <div className="my-6 flex flex-wrap justify-center gap-4 text-xs">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Revi. All rights reserved</span>
            </div>
        </footer>
    )
}