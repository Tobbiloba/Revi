 ...
 */
export class Client {
    public readonly capture: capture.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.capture = new capture.ServiceClient(base)
 ...
 */
import { captureError as api_capture_error_captureError } from "~backend/capture/error";
...
export namespace capture {
    ...
    export class ServiceClient {
         ...
         */
        public async captureError(params: RequestType<typeof api_capture_error_captureError>): Promise<ResponseType<typeof api_capture_error_captureError>> {
            ...
            const resp = await this.baseClient.callTypedAPI(`/api/capture/error`, {headers, method: "POST", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_capture_error_captureError>
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { listErrors as api_errors_list_listErrors } from "~backend/errors/list";
...
export namespace errors {
    ...
    export class ServiceClient {
         ...
         */
        public async listErrors(params: RequestType<typeof api_errors_list_listErrors>): Promise<ResponseType<typeof api_errors_list_listErrors>> {
            // Convert our params into the objects we need for the request
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/errors/${encodeURIComponent(params.projectId)}`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_errors_list_listErrors>
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { healthCheck as api_health_check_healthCheck } from "~backend/health/check";
...
export namespace projects {
    ...
    export class ServiceClient {
        ...
        public async create(params: RequestType<typeof api_projects_create_create>): Promise<ResponseType<typeof api_projects_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/projects`, {method: "POST", body: JSON.stringify(params)})
        ...
        public async get(params: { id: number }): Promise<ResponseType<typeof api_projects_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/projects/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getSessionEvents as api_sessions_events_getSessionEvents } from "~backend/sessions/events";
import { getSessionReplay as api_sessions_replay_getSessionReplay } from "~backend/sessions/replay";
...
export namespace sessions {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.getSessionReplay = this.getSessionReplay.bind(this)
        }

        /**
         * Retrieves the complete timeline of events for a session including DOM events, network calls, and errors.
         */
        public async getSessionEvents(params: { sessionId: string }): Promise<ResponseType<typeof api_sessions_events_getSessionEvents>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/session/${encodeURIComponent(params.sessionId)}/events`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_sessions_events_getSessionEvents>
        }

        /**
         * Retrieves session replay data formatted for frontend replay components.
         */
        public async getSessionReplay(params: { sessionId: string }): Promise<ResponseType<typeof api_sessions_replay_getSessionReplay>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/session/${encodeURIComponent(params.sessionId)}/replay`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_sessions_replay_getSessionReplay>
        }
    }
}
