...
```bash
git remote add encore encore://revi-backend-pbei
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/revi-backend-pbei/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/revi-backend-pbei/settings/integrations/github)
